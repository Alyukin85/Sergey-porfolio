...
<ul>
    <li>BI аналитика,</li>
    <li>найм персонала,</li>
    <li>управлением персоналом (Колл-центр, отдел продаж, отдел маркетинга, преподавательский состав)</li>
...
<ul>
    ...
    <li>Создание Колл-центра</li>
    <li>групповой найм персонала, обучение продажам</li>
</ul>ul>
